    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center gap-4">
            <div className="w-full h-full">
                <img src={imageTrainner} alt="Descrição da imagem" className="opacity-90 w-full h-full rounded-md" />
            </div>
            <div className="flex flex-col gap-1">
                <h1 className="text-[1.2rem] font-bold text-center">Bem vindo a seção de treinos</h1>
